...
function main()
  ...
  push!(Window.click_callbacks, Cube.click_callback)
  push!(Window.click_callbacks, Axes.click_callback)
  window = Window.createWindow()
  GL.initDebug()
  Axes.init(window)
  Cube.init(window)
  Cube.loadDate("2021-11-10")
  Cube.loadSymbol(Aggs.default_symbol)
  ...
  while !GLFW.WindowShouldClose(window)
    ...
    Axes.handleInput(window, loop_time)
